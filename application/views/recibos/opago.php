...
<div class="container">
    <div class="row"  id="terminado">
        <div class="col-md-12">   
            <a class="btn btn-primary" href="<?php echo base_url(); ?>recibos/ctacte/<?=$proveedor->id?>">Se Grabo el Recibo Corectamente</a>
        </div>
    </div>
    ...
    <div class="row" id="principal">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">            
                <div class="panel-heading">FACTURAS IMPAGAS - <?=$proveedor->cliente?></div>
    ...
    <!MODALS !>
    <?php
    $this->load->view('recibos/frmEfectivo');
    $this->load->view('recibos/frmTransferencia');
    $this->load->view('recibos/frmcheques');    
    $this->load->view('recibos/frmchequespro');    
    $this->load->view('recibos/frmOtroPago');  
    ?>  
...
var CFG = {
    ...
    $(document).ready(function(){
        ...
        $("#bntIngEfe").click(function(){              
            $.post(CFG.url + 'recibos/ingreso_pago_efectivo/',
        ...
        $("#bntIngChe3").click(function(){              
            $.post(CFG.url + 'recibos/ingreso_pago_cheque3/',
            {id_aux:$("#id_pago_aux").val(),
        ...
        $("#bntIngChe").click(function(){                   
            $.post(CFG.url + 'recibos/ingreso_pago_cheque/',
            {id_aux:$("#id_pago_aux").val(),
             che_nro:$("#che_nro").val(),
        ...
        $("#bntIngTra").click(function(){                   
            $.post(CFG.url + 'recibos/ingreso_pago_traf/',
            {id_aux:$("#id_pago_aux").val(),             
        ...
        $("#bntIngOtr").click(function(){                   
            $.post(CFG.url + 'recibos/ingreso_pago_otro/',
            {id_aux:$("#id_pago_aux").val(),             
    ...
    function recalcular(){
        $.post(CFG.url + 'recibos/recalcular/',
            {id_aux:$("#id_pago_aux").val()},
            function(data){  
    ...
    function borro(id){
        $.post(CFG.url + 'recibos/borro_opago_aux/',
            {id_aux:id},
            function(data){  
                recalcular();
            });           
    ...
    function guardar(){
        ...
        $("#alerta").hide();   
        $.post(CFG.url + 'recibos/finalizar_opago/',
            {id_aux:$("#id_pago_aux").val(),             
             compro:cancela,
